    ...
    return (
        <>
            ...
            {isOpen && (
                ...
                >
                    <motion.div initial='hidden' animate='show' variants={fadeIn("left", "spring", .1, 0.5)} className="bg-light dark:bg-background rounded-lg shadow-lg border  top-20 absolute right-8 h-[350px] w-72 border-background/50 dark:border-light/50" onClick={(e) => e.stopPropagation()}>
