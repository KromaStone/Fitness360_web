...
function JoinToday() {
    ...
    return (
        <section className='py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 px-5 md:px-10 lg:px-20 xl:px-52 bg-cover h-auto bg-light text-background dark:bg-background dark:text-light'>
