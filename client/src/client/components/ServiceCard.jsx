    ...
    return (
        <>
            <motion.div
                ...
                className="group hover:bg-primary hover:text-light bg-secondlight dark:bg-secondary rounded-3xl flex flex-col gap-3 h-fit transition text ease-in-out duration-300 dark:hover:bg-primary mt-4"
            >
                <motion.div
                    whileInView="show"
                    initial="hidden"
