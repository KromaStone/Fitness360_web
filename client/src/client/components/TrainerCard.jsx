    ...
    return (
        <>
            <motion.div
                ...
                className={`group bg-transparent dark:bg-transparent p-1 rounded-3xl flex flex-col h-fit transition text ease-in-out duration-300 mt-4 w-full max-w-[300px]`}
            >
